...
const ThirdTab = () => {
  return (
    <section className="ThirdTab">
      ...
      <p>I'm on the <a href="https://www.scottishbooktrust.com/authors/andrew-blair">Scottish Book Trust's Live Literature Author Directory <img id='external-link' title='external link' src='/images/external-link.png' /></a>.</p>
