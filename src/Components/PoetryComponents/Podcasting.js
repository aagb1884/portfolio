...
const [isVisible, setIsVisible] = useState(false);
  ...
  return ( 
      ...
      where we wrote fresh cards for each show and asked poets to ruin each others' work with them. Secondly we had <i>Lies, Dreaming</i> which was a theme-driven submission show, where we asked people to send in their work on a certain theme (such as 'A piano, falling' or 'Tim Henman').
      Thirdly we had 'Eight Poems That, If You Had To Be Trapped In Some Way For a Prolonged Period of Time With Little Hope Of Rescue', which was essentially <i>Desert Island Discs</i> but with poems.</p>
      <p>We also produced podcasts where we asked poets and performers to produce either a feature set or a longform piece of spoken word. You can buy these <a href="https://poetryasfuck.bandcamp.com/">here</a>.</p>
      ...
      four episodes of it <a href="https://soundcloud.com/poetryasfuck">here.</a></p>
