...
const [isVisible, setIsVisible] = useState(false);
  ...
  return ( 
      ...
      <p>This was a monthly spoken word podcast that comprised of three different formats: <a href="https://www.theskinny.co.uk/festivals/edinburgh-fringe/comedy/poets-against-humanity-comedy-spotlight"><i>Poets Against Humanity</i></a>  - a Creative Commons remix of 'Cards Against Humanity' where we wrote fresh cards for each show and asked poets to ruin each others' work with them. Secondly we had <i>Lies, Dreaming</i> which was a theme-driven submission show, where we asked people to send in their work on a certain theme (such as 'A piano, falling' or 'Tim Henman').
